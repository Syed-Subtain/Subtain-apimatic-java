...
https://central.sonatype.com/artifact/io.github.sufyankhanrao/subtain-apimatic/9.1.4

## Initialize the API Client

**_Note:_** Documentation for the client can be found [here.](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/client.md)
...
| `httpClientConfig` | [`Consumer<HttpClientConfiguration.Builder>`](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/http-client-configuration-builder.md) | Set up Http Client Configuration instance. |
| `basicAuthCredentials` | [`BasicAuthCredentials`](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/auth/basic-authentication.md) | The Credentials Setter for Basic Authentication |
...
* [`BasicAuth (Basic Authentication)`](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/auth/basic-authentication.md)

## List of APIs

* [API Exports](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/api-exports.md)
* [Advance Invoice](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/advance-invoice.md)
* [Billing Portal](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/billing-portal.md)
* [Custom Fields](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/custom-fields.md)
* [Events-Based Billing Segments](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/events-based-billing-segments.md)
* [Payment Profiles](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/payment-profiles.md)
* [Product Families](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/product-families.md)
* [Product Price Points](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/product-price-points.md)
* [Proforma Invoices](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/proforma-invoices.md)
* [Reason Codes](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/reason-codes.md)
* [Referral Codes](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/referral-codes.md)
* [Sales Commissions](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/sales-commissions.md)
* [Subscription Components](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/subscription-components.md)
* [Subscription Groups](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/subscription-groups.md)
* [Subscription Group Invoice Account](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/subscription-group-invoice-account.md)
* [Subscription Group Status](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/subscription-group-status.md)
* [Subscription Invoice Account](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/subscription-invoice-account.md)
* [Subscription Notes](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/subscription-notes.md)
* [Subscription Products](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/subscription-products.md)
* [Subscription Status](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/subscription-status.md)
* [Coupons](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/coupons.md)
* [Components](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/components.md)
* [Customers](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/customers.md)
* [Events](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/events.md)
* [Insights](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/insights.md)
* [Invoices](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/invoices.md)
* [Offers](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/offers.md)
* [Products](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/products.md)
* [Sites](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/sites.md)
* [Subscriptions](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/subscriptions.md)
* [Webhooks](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/controllers/webhooks.md)

## Classes Documentation

* [Utility Classes](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/utility-classes.md)
* [HttpRequest](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/http-request.md)
* [HttpResponse](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/http-response.md)
* [HttpStringResponse](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/http-string-response.md)
* [HttpContext](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/http-context.md)
* [HttpBodyRequest](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/http-body-request.md)
* [HttpCallback Interface](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/http-callback-interface.md)
* [Headers](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/headers.md)
* [ApiException](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/api-exception.md)
* [Configuration Interface](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/configuration-interface.md)
* [HttpClientConfiguration](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/http-client-configuration.md)
* [HttpClientConfiguration.Builder](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/9.1.4/doc/http-client-configuration-builder.md)
