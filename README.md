...
https://mvnrepository.com/artifact/io.github.sufyankhanrao/subtain-apimatic/6.6.6
...
| `httpClientConfig` | [`ReadonlyHttpClientConfiguration`](https://www.github.com/Syed-Subtain/Subtain-apimatic-java/tree/6.6.6/doc/http-client-configuration.md) | Http Client Configuration instance. |
