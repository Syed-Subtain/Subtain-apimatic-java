...
| `applications` | `Boolean` | Query, Optional | Include applications data<br>**Default**: `false` |
...
```java
String uid = "uid0";
VoidInvoiceRequest body = new VoidInvoiceRequest.Builder(
...
```java
String uid = "uid0";
RefundInvoiceRequest body = new RefundInvoiceRequest.Builder(
...
```java
String uid = "uid0";
CreateInvoicePaymentRequest body = new CreateInvoicePaymentRequest.Builder(
    new CreateInvoicePayment.Builder()
        .amount(CreateInvoicePaymentAmount.fromPrecision(
            124.33D
        ))
        .memo("for John Smith")
...
```java
String uid = "uid0";
SendInvoiceRequest body = new SendInvoiceRequest.Builder()
