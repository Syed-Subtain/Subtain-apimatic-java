...
public abstract class CustomPriceUsedForSubscriptionCreateUpdatePriceInCents {
     ...
     */
    public static CustomPriceUsedForSubscriptionCreateUpdatePriceInCents fromNumber(int number) {
    ...
    private static class NumberCase extends CustomPriceUsedForSubscriptionCreateUpdatePriceInCents {
